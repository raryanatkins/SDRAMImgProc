...
# ACDS 17.1 590 win32 2019.03.30.11:24:42
# ----------------------------------------
...
alias file_copy {
  ...
  file copy -force $QSYS_SIMDIR/div_memoryC1_uid150_invTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/div_memoryC1_uid151_invTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/div_memoryC2_uid154_invTables_lutmem.hex ./
}
