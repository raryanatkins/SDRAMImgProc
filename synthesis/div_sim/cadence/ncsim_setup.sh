...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  ...
  cp -f $QSYS_SIMDIR/div_memoryC1_uid150_invTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/div_memoryC1_uid151_invTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/div_memoryC2_uid154_invTables_lutmem.hex ./
fi
