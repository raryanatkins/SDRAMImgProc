...
# ACDS 17.1 590 win32 2019.06.19.10:13:27
# ----------------------------------------
...
# ----------------------------------------
# If fp is one of several IP cores in your
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fp.vo"
}
